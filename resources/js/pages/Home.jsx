                        ...
                        <div className="flex flex-row justify-between">
                            <div>
                                <div className="flex flex-row">
                                    ...
                                    <Separator className="max-w-[300px] mt-[22px] ml-2 h-1 bg-gray-900" />
                                </div>
                    ...
                    <div className="relative flex items-center">
                        ...
                        <div className="flex justify-between items-center relative w-[750px] mx-auto z-10">
                            <div className="relative z-20 bg-transparent">
                                <img src={images.beef} alt="" className="w-[70px] h-[70px] flex-shrink-0" />
                            </div>
                            <div className="relative z-20 bg-transparent">
                                <img src={images.seafood} alt="" className="w-[70px] h-[70px] flex-shrink-0" />
                            </div>
                            <div className="relative z-20 bg-transparent">
                                <img src={images.chicken} alt="" className="w-[70px] h-[70px] flex-shrink-0" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="relative z-10 max-w-[1100px] mx-auto text-black mt-[100px] mb-[100px]">
                <div className="grid grid-cols-2">
                    <div>
                        ...
                        <div className="mt-2 text-semibold text-[30px] text-[#d4a564]">
                    ...
                    <div>
                        <img src={images.paradigm} alt="" className="max-w-[450px] mx-auto" />
                    </div>
                </div>
            </div>
        </React.Fragment>
